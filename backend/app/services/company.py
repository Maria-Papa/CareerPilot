...
class CompanyService(SoftDeleteService[Company]):
    ...
    def list_companies(self, session: Session, *, offset: int = 0, limit: int = 100) -> Sequence[Company]:
    ...
    def get_company_including_deleted(self, session: Session, company_id: int) -> Company | None:
    ...
    def update_company(self, session: Session, company: Company, data: CompanyUpdate) -> Company:
