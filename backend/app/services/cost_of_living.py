...
class CostOfLivingService(BaseService[CostOfLiving]):
    ...
    def list_costs(self, session: Session, *, offset: int = 0, limit: int = 100) -> Sequence[CostOfLiving]:
    ...
    def update_cost(self, session: Session, col: CostOfLiving, data: CostOfLivingUpdate) -> CostOfLiving:
    ...
    def adjust_yearly_cost(self, session: Session, col: CostOfLiving, new_cost: int) -> CostOfLiving:
