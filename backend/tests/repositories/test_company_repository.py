...
def test_add_and_get(repo, db_session):
...
def test_get_all_and_find(repo, db_session):
...
def test_update(repo, db_session):
...
def test_soft_delete_and_restore(repo, db_session):
...
def test_delete_permanent(repo, db_session):
