...
def repo_mock() -> MagicMock:
    """Mocked CompanyRepository with spec enforcement."""
    return MagicMock(spec=CompanyRepository)


@pytest.fixture
def service(repo_mock: MagicMock) -> CompanyService:
    """CompanyService instance using the mocked repository."""
...
def test_get_company_success(service: CompanyService, repo_mock: MagicMock) -> None:
    session = MagicMock()
...
def test_create_company(service: CompanyService, repo_mock: MagicMock) -> None:
    session = MagicMock()
...
def test_update_company(service: CompanyService, repo_mock: MagicMock) -> None:
    session = MagicMock()
